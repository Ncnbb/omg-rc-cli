...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/ts/js/ts.ts");
/******/ })
/************************************************************************/
/******/ ({
...
say('LamHo');
var getApi = new _Users_lamho_Desktop_Ncnbb_omg_rc_cli_node_modules_babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve) {
  resolve('123');
});
var object = {
  a: 1,
